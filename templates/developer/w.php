...
<script>
    document.addEventListener('DOMContentLoaded', function () {
        ...
        const items = [
            ...
            { text: '<?php echo sprintf(__('%s %s', 'G3'), __('Frontend', 'G3'), __('Editor', 'G3')); ?>' },
            { text: '<?php echo sprintf(__('%s %s', 'G3'), __('Activity', 'G3'), __('Feature', 'G3')); ?>' },
            { text: '<?php echo sprintf(__('%s %s', 'G3'), __('Announcement', 'G3'), __('Feature', 'G3')); ?>' },
            { text: '<?php echo sprintf(__('%s %s', 'G3'), __('Community', 'G3'), __('System', 'G3')); ?>' },
            { text: '<?php echo sprintf(__('%s %s', 'G3'), __('Ad', 'G3'), __('Management', 'G3')); ?>' },
            { text: '<?php echo sprintf(__('%s %s', 'G3'), __('Shop', 'G3'), __('System', 'G3')); ?>' },
            { text: '<?php echo sprintf(__('%s %s', 'G3'), 'SKU', __('System', 'G3')); ?>' },
            { text: '<?php echo sprintf(__('%s %s', 'G3'), __('Orders', 'G3'), __('System', 'G3')); ?>' },
            { text: '<?php echo sprintf(__('%s %s', 'G3'), __('Payment', 'G3'), __('System', 'G3')); ?>' },
            { text: '<?php echo sprintf(__('%s %s', 'G3'), __('Balance', 'G3'), __('Management', 'G3')); ?>' },
            { text: '<?php echo sprintf(__('%s %s', 'G3'), __('Transaction', 'G3'), __('System', 'G3')); ?>' },
            { text: '<?php echo sprintf(__('%s %s', 'G3'), __('Credits', 'G3'), __('System', 'G3')); ?>' },
            { text: 'Tokens Support' },
            { text: '<?php echo sprintf(__('%s %s', 'G3'), __('Store Management', 'G3'), __('System', 'G3')); ?>' },
            { text: '<?php echo sprintf(__('%s %s', 'G3'), __('Wechat OA', 'G3'), __('Support', 'G3')); ?>' },
            { text: '<?php echo sprintf(__('%s %s', 'G3'), __('Membership', 'G3'), __('System', 'G3')); ?>' },
            { text: '<?php echo sprintf(__('%s %s', 'G3'), __('Marketing', 'G3'), __('Tools')); ?>' },
            { text: '<?php echo sprintf(__('%s %s', 'G3'), __('Social', 'G3'), __('Login', 'G3')); ?>' },
            { text: '<?php echo sprintf(__('%s %s', 'G3'), __('Subscribe', 'G3'), __('Login', 'G3')); ?>' },
            { text: '<?php echo sprintf(__('%s %s', 'G3'), __('Multi-theme', 'G3'), __('Mode', 'G3')); ?>' },
            ...
            { text: '<?php echo sprintf(__('%s %s', 'G3'), __('Queue', 'G3'), __('Service', 'G3')); ?>' },
            { text: '<?php _e('Custom Admin', 'G3'); ?>' },
            { text: '<?php echo sprintf(__('%s %s', 'G3'), __('Security', 'G3'), __('Tools')); ?>' },
