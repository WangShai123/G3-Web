...
return [
    ...
    // G3
    'g3.redirect'            => [G3_ASSETS_URL . '/js/g3.redirect.min.js', [], '1.0.0'],
    'g3.admin'               => [G3_ASSETS_URL . '/js/g3.admin.min.js', ['jquery', 'jui'], '1.0.0'],
    'g3.customer.admin'      => [G3_ASSETS_URL . '/js/g3.customer-admin.min.js', ['jui'], '1.0.0'],
    // G3 Theme Helpers
    'g3.login.modal'         => [G3_ASSETS_URL . '/js/g3.login.modal.min.js', ['vanilla-signal', 'jui', 'vanilla-signal-i18n', 'vanilla-signal-query'], '1.0.0'],
    // Template Scripts
    'g3.media.upload'        => [G3_ASSETS_URL . '/js/g3.template.media.upload.min.js', ['jquery'], '1.0.0'],
