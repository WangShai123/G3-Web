...
abstract class Components {
    ...
    private function internalInit(): void
    {
        ...
        $this->panelRenderer = $this->container->get(PanelRenderer::class);
    ...
    protected function createPanel(string $tabSlug = 'general')
    {
        $firstPanel = $this->firstPanel();
        if (!$firstPanel instanceof Panel) {
            return;
        }
        $this->panelRenderer->render($this, $firstPanel, $tabSlug);
    }
    ...
    protected function registerUMD(array $scripts): array
    {
        return $scripts;
    }
    protected function registerESM(array $modules): array
    {
        return $modules;
    }
    protected function registerCSS(array $styles): array
    {
        return $styles;
    }
