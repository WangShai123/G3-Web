...
final class Panel {
    ...
    public function tab(string $id, string $title): self
    {
    ...
    public function page(string $id, string $title): self
    {
        $page             = Section::make($id, $title);
        $this->pages[$id] = $page;
        $this->current    = $page;
        return $this;
    }
    ...
    {
        $this->current()?->option($name, $defaults, $autoload);
        return $this;
    }
    ...
    {
        $this->current()?->password($id, $title, $description);
        return $this;
    }
    ...
    {
        $this->current()?->time($id, $title, $description);
        return $this;
    }
    ...
    {
        $this->current()?->file($id, $title, $description);
        return $this;
    }
    ...
    {
        $this->current()?->checkbox($id, $title, $options, $description, $horizontal);
        return $this;
    }
    ...
    {
        $this->current()?->radio($id, $title, $options, $description, $horizontal);
        return $this;
    }
