...
use JEALER\G3\Core\Container\DefinitionInterface;
...
use JEALER\G3\Core\Container\ParameterManagerInterface;
use JEALER\G3\Core\Container\ParameterManager;
use JEALER\G3\Core\Container\ServiceDecoratorInterface;
use JEALER\G3\Core\Container\ServiceDecorator;
use JEALER\G3\Core\Container\TagManagerInterface;
use JEALER\G3\Core\Container\TagManager;
use JEALER\G3\Core\Container\ExtensionManagerInterface;
use JEALER\G3\Core\Container\ExtensionManager;
use JEALER\G3\Core\Container\ContainerExtensionInterface;
...
class Container implements PsrContainerInterface {
    ...
    /**
     * Get instance by id or class name, if not exists, will try to auto resolve and create instance. PSR-11 API
