...
$postService = Container::run()->get(PostService::class);
$seo         = $postService->getSeoItems();
?>
<!DOCTYPE html>
<html lang="<?php echo esc_attr($lang); ?>" <?php Frontend::htmlClass(); ?>>
<head>
    <meta charset="UTF-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
    <meta name="generator" content="G3-Web">
    <meta name="author" content="JEALER">
