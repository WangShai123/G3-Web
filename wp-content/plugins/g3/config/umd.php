...
return [
    ...
    'vanilla-signal-query'   => [G3_JS_URL . '/vanilla-query.umd.js', ['vanilla-signal', 'vanilla-simple-lru'], '0.2.5', 'https://unpkg.com/vanilla-query@latest/dist/index.umd.js'],
    'vanilla-create-storage' => [G3_JS_URL . '/vanilla-storage.umd.js', [], '0.2.3', 'https://unpkg.com/vanilla-storage@latest/dist/index.umd.js'],
    'vanilla-signal-i18n'    => [G3_JS_URL . '/vanilla-i18n.umd.js', ['vanilla-signal'], '0.2.0', 'https://unpkg.com/vanilla-i18n@latest/dist/index.umd.js'],
    // JUI
    'jui'                    => [G3_JS_URL . '/jui.umd.js', ['vanilla-signal', 'vanilla-signal-i18n'], '0.4.0', 'https://unpkg.com/vanilla-jui@latest/dist/index.umd.js'],
