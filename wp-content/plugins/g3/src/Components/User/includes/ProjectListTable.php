...
class ProjectListTable extends WP_List_Table {
    ...
    public function display(): void
    {
        ...
        if ($this->ifDisplay()) {
            ...
            $this->display = false;
            echo Element::tip(__('Please config the membership duration first.', 'G3'), '', 'danger');
        }
    ...
    {
        return Option::get(UserService::DURATION_OPTION_KEY);
    }

    private function getGroup()
    {
        return Option::get(UserService::GROUP_OPTION_KEY, [], false);
    }
    ...
    {
        return Option::get(UserService::MEMBERSHIP_OPTION_KEY, [], false);
    }
